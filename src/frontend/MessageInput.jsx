// Handle regular scrolling (scrollbar dragging, programmatic scrolling)
...
const [caretInfo, setCaretInfo] = useState({ line: 1, column: 1 });
...
// Calculate and update caret position information
const updateCaretInfo = () => {
  ...
  // VS Code-like scrolling behavior
  ensureCaretVisible(line);
};

// Ensure caret remains visible with VS Code's margin behavior
const ensureCaretVisible = (line) => {
  ...
  // Only scroll if the position would actually change
...
// Update caret info without changing scroll position
